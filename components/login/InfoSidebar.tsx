  ...
  return (
    <div className="relative h-1/2 w-full flex-col gap-2 overflow-hidden bg-slate-300 dark:bg-slate-600 md:h-full md:w-2/3">
      ...
      <img
        ...
        className="ml-10 mt-5 h-96 origin-top-left rounded-l-xl object-cover object-left-top shadow-lg shadow-slate-900/50 dark:shadow-slate-100/50 md:ml-20 md:mt-10 md:h-[70vh]"
      />
    </div>
  );
};
