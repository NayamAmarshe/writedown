...
export default function HeroSection() {
  ...
  const primaryCtaLabel = isAuthenticated ? "Write Now" : "Try Now";
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                <h1 className="mx-auto mt-8 flex max-w-4xl flex-col items-center gap-3 text-balance text-center lg:mt-16">
                  <TextEffect
                    preset="fade-in-blur"
                    speedSegment={0.3}
                    per="word"
                    as="span"
                    className="block text-5xl font-semibold md:text-7xl xl:text-[5.25rem]"
                  >
                    Upgrade Your
                  </TextEffect>
                  <TextEffect
                    ...
                    as="span"
                    className={cn(
                      "block text-5xl font-light md:text-7xl xl:text-[5.25rem]",
                      pacifico.className
                    )}
                  >
                    Dear Diary
                ...
                >
                  All your notes, synced on every device. Free, easy and fast.
                </TextEffect>
