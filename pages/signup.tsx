...
const Signup: NextPage = () => {
  return (
    ...
    <div className='bg-white bg-opacity-40 py-24 px-10 mx-5 rounded-xl'>
        ...
        <button type='button' className='w-50% py-3 px-2 inline-flex justify-center items-center gap-2 rounded-md  font-medium bg-black text-white align-middle hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm mb-6 '>
            Sign In with Google
        </button>
        <button type="button" className="w-50% py-3 px-2 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm">
